# physicsforge-chapter2 - Electrostatic Potential and Capacitance Visual Notes

A premium-style, zero-cost visual notes website for **NCERT Class 12 Physics Chapter 2: Electrostatic Potential and Capacitance**.
...
Create a GitHub repository named `physicsforge-chapter2`, push this project, and use GitHub Pages from the `gh-pages` branch.

For a repository path build:

```bash
VITE_BASE_PATH=/physicsforge-chapter2/ pnpm build
```
